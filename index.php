...
<div class="page-container">
  ...
  <div class="platform-choice-area">
      ...
      <iframe src="https://embed.music.apple.com/us/playlist/power-off/pl.fcd3abfac1eb489eb8081362c777696a?app=music&amp;itsct=music_box&amp;itscg=30200" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation-by-user-activation" allow="autoplay *; encrypted-media *;" style="width: 100%; max-width: 300px; overflow: hidden; border-radius: 10px; background: transparent none repeat scroll 0% 0%;" height="100vh" frameborder="0"></iframe>
      </div>
