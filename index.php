...
<?php
  ...
  if ($accessToken != "") {
    ...
    echo '<p><a href="https://accounts.spotify.com/authorize?client_id=be5ee3a4215c4df69d8149f599c5134a&response_type=token&scope=user&redirect_uri=https://illustratemyalbumcover.com/slimgemz/signin/callback">Sign in to Spotify</a></p>';
  }
